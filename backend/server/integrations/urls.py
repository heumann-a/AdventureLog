...
from integrations.views import IntegrationView, StravaIntegrationView, GarminIntegrationView, WandererIntegrationViewSet
...
router.register(r'garmin', GarminIntegrationView, basename='garmin')
